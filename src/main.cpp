...
uint256 hashGenesisBlock("0x000001aeef7217d14747d2d8b7b70df914fe247a1c3fca7930c70f7e8b6e2bdc");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Bamboo: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Bamboo Signed Message:\n";
...
{
    // Bamboo: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    // Bamboo: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
	    ...
	    hashGenesisBlock = uint256("0x0000072f90f1e3ad23518c182dfe7ee17156779ad5882e2e46cc28f9ebd06386");
    }
...
bool InitBlockIndex() {
	...
	// Mainnet Genesis block:
		...
		const char* pszTimestamp = "Bamboo is born";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1429129661;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 122526;

        if (fTestNet)
        {
            block.nTime    = 1429110209;
            block.nNonce   = 2095693;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1508ff24a8c23e948a8e236a888317df1362cd3cac9f477f4227e8861b39693b"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc3, 0xb9, 0xde }; // Bamboo: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("BambooMiner : ProcessBlock, block not accepted");
    }
